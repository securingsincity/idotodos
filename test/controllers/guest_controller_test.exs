defmodule IdotodosEx.GuestControllerTest do
  use IdotodosEx.AuthConnCase

  alias IdotodosEx.Guest
  @valid_attrs %{city: "some content", email: "some@content.com", first_name: "some content", gender: "some content", last_name: "some content", middle_name: "some content",   state: "some content", street: "some content", suite: "some content", zip_code: "some content"}
  @invalid_attrs %{}
  ...
  test "creates resource and redirects when data is valid", %{conn: conn} do
    ...
    assert Repo.get_by(Guest, %{email: "some@content.com"})
  end
  ...
  test "updates chosen resource and redirects when data is valid", %{conn: conn} do
    guest = Repo.insert! Map.merge(%Guest{}, @valid_attrs)
    conn = put conn, guest_path(conn, :update, guest), guest: %{@valid_attrs | first_name: "james"}
    assert redirected_to(conn) == guest_path(conn, :show, guest)
    assert Repo.get_by(Guest, %{ first_name: "james"})
  end
