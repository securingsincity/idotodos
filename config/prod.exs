...
config :idotodos_ex, IdotodosEx.Endpoint,
  ...
  url: [scheme: "https", host: "idotodos.herokuapp.com", port: 443],
...
config :guardian, Guardian,
  ...
  secret_key: System.get_env("GUARDIAN_SECRET_KEY"), #overwrite in prod.secrets
...
# start per endpoint:
#
#     config :idotodos_ex, IdotodosEx.Endpoint, server: true
#
